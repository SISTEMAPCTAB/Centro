const CACHE='centro-2026-v-final-pdf-2';
const ASSETS=['./','./index.html','./styles.css?v=final-pdf-2','./app.js?v=final-pdf-2','./manifest.webmanifest','./documentos/Plan_Integral_Emergencia_Centro_2026.pdf'];
